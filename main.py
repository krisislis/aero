...
extractor = ApiExtractor(url='https://random-data-api.com/api/cannabis/random_cannabis?size=10')
loader = PostgresLoader(db_params=DB_PARAMS, table=table, columns=data_model.get_columns())
el_process = ELProcess(extractor=extractor, loader=loader, data_model=CannabisModel)
el_process.run()
